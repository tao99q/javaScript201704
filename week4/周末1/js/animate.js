    ...
    function animate(ele,target,duration,callback){
        ...
        ele.timer=window.setInterval(function(){
            ...
            for(var key in begin){
                public .css(ele,key,linear(begin[key],target[key],duration,time));
            }
        },17)
...
//animate(box,{left:600,top:500},2000);
(function () {
    function animate(ele,target){
        ...
        var callback=fnAry.length>0?fnAry[0]:function(){};
        var duration=num1Ary.length>0?num1Ary[0]:2000;
        var effectNum=num2Ary.length>0?num2Ary[0]:0;
        var Effect = {
            //匀速
            Linear: function (t, b, c, d) {
                return c * t / d + b;
        ...
        ele.timer=window.setInterval(function(){
            ...
            time+=10;
            for(var key in begin){
                public .css(ele,key,effectAry[effectNum](time,begin[key],target[key]-begin[key],duration));
